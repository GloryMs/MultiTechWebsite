...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the About Us page: story, vision, mission, timeline, values, and team';
  ...
  attributes: {
    core_values: Schema.Attribute.Component<'about.core-value', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    story_p1: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    story_p2: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    story_p3: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    team_members: Schema.Attribute.Component<'about.team-member', true>;
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings: contact info, social links, footer text';
...
export interface ApiJobOpeningJobOpening extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Career opportunities at Multitech';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portfolio projects and references';
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Multitech service offerings';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    full_desc: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
